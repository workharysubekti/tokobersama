    ...
    >
      ...
      >
        <div class="text-center mb-8">
          ...
          <p class="text-[9px] text-gray-500 tracking-[0.3em] uppercase mt-1">
            Submit User Performance Review
          </p>
        </div>
        <div class="space-y-6">
          ...
          <textarea
            ...
            rows="4"
            placeholder="Describe the transmission quality..."
            class="w-full bg-black border border-white/10 rounded-3xl p-5 text-xs text-white outline-none focus:border-yellow-500 resize-none italic"
          ></textarea>
          <button
            @click="submitReview"
            :disabled="submittingReview"
            class="w-full bg-yellow-500 text-black py-5 rounded-3xl font-black text-[10px] italic"
          >
